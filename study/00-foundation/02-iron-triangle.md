...
**Lưu ý:** Thêm người vào project không luôn luôn giải quyết được time. Fred Brooks đã nói: _"Adding manpower to a late software project makes it later"_ (The Mythical Man-Month). Developer mới cần thời gian onboard, hỏi han, review — làm chậm người cũ.
...
Khách hàng gọi điện: _"Chúng tôi vừa quyết định thêm module tính lương tự động vào scope. Không thay đổi deadline và budget."_
...
**Tình huống:** Dự án app giao đồ ăn cho chuỗi nhà hàng. Deadline ban đầu: 01/12. Ngày 15/10, CEO thông báo: _"Chúng ta phải demo cho investor ngày 01/11. Tất cả tính năng phải có."_
...
_Xem gợi ý đáp án tại: [exercises/01-phan-tich-iron-triangle.md](./exercises/01-phan-tich-iron-triangle.md)_
