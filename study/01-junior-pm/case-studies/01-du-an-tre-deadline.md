...
**Ngày D+60 (cuối tháng 2):** Team lead báo cáo trong weekly standup: _"Chúng ta cần thêm 6 tuần mới có thể deliver đủ scope."_
...
_Dừng lại và suy nghĩ trước khi đọc hướng giải quyết:_
...
**Action cho PM:** Ngay từ kickoff, phải communicate rõ với cả team và khách hàng: _"Mọi yêu cầu thay đổi đều phải qua PM. Developer không được tự ý nhận thêm việc từ stakeholder."_
